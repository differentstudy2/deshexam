...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronLeft className={cn("transition-transform duration-200", state === 'collapsed' && "rotate-180")}/>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2", state === 'collapsed' && 'p-1.5', className)}
      {...props}
    />
  )
})
