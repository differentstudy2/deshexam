...
const translations = {
    en: {
        ...
        title: "Learn Numbers 91 to 100",
        description: "Click on a number to hear its name.",
        tapToListen: "Tap to listen",
        numberNames: ['Ninety-one', 'Ninety-two', 'Ninety-three', 'Ninety-four', 'Ninety-five', 'Ninety-six', 'Ninety-seven', 'Ninety-eight', 'Ninety-nine', 'One Hundred'],
    },
    hi: {
        back: "नंबर सीखें पर वापस जाएं",
        title: "संख्याएँ 91 से 100 सीखें",
        description: "किसी संख्या का नाम सुनने के लिए उस पर क्लिक करें।",
        tapToListen: "सुनने के लिए टैप करें",
        numberNames: ['इक्यानबे', 'बानबे', 'तिरानबे', 'चौरानबे', 'पंचानबे', 'छियानबे', 'सत्तानबे', 'अट्ठानबे', 'निन्यानबे', 'एक सौ'],
    },
    bn: {
        back: "সংখ্যা শেখা পৃষ্ঠায় ফিরে যান",
        title: "সংখ্যা ৯১ থেকে ১০০ শিখুন",
        description: "সংখ্যার নাম শুনতে সেটির উপর ক্লিক করুন।",
        tapToListen: "শুনতে ট্যাপ করুন",
        numberNames: ['একানব্বই', 'বিরানব্বই', 'তিরানব্বই', 'চুরানব্বই', 'পঁচানব্বই', 'ছিয়ানব্বই', 'সাতানব্বই', 'আটানব্বই', 'নিরানব্বই', 'একশো'],
    }
};
...
export default function LearnNumbers91To100Page() {
    ...
    const numbers = Array.from({ length: 10 }, (_, i) => 91 + i);
