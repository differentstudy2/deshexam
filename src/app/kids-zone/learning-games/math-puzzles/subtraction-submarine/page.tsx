...
import { ArrowLeft, RefreshCw, Check, X, Sparkles, Delete, Clock, Settings, Trophy, Rows, Mic, BarChart4, Languages, Minus } from "lucide-react";
...
const translations = {
    en: {
        ...
        pageTitle: "Subtraction Submarine",
        pageDescription: "Subtract the numbers and find the correct answer!",
        mode: "Mode:",
        ...
        clear: "Clear",
        ttsPrompt: (num1: number, num2: number) => `Tell me, what is ${num1} minus ${num2}?`
    },
    hi: {
        backToPuzzles: "गणित पहेलियों पर वापस जाएं",
        pageTitle: "घटाव पनडुब्बी",
        pageDescription: "संख्याओं को घटाएं और सही उत्तर चुनें!",
        mode: "मोड:",
        inputMode: "नंबर पैड",
        mcqMode: "बहुविकल्पी",
        voiceMode: "आवाज",
        ...
        clear: "नया",
        ttsPrompt: (num1: number, num2: number) => `बताओ, ${toDevanagari(num1)} में से ${toDevanagari(num2)} घटाने पर कितना होता है?`
    },
    bn: {
        backToPuzzles: "গণিত ধাঁধায় ফিরে যান",
        pageTitle: "বিয়োগ সাবমেরিন",
        pageDescription: "সংখ্যাগুলো বিয়োগ করুন এবং সঠিক উত্তরটি বেছে নিন!",
        mode: "মোড:",
        ...
        clear: "মুছুন",
        ttsPrompt: (num1: number, num2: number) => `বলো, ${toBengaliNumerals(num1)} থেকে ${toBengaliNumerals(num2)} বিয়োগ করলে কত হয়?`
    }
}
...
export default function SubtractionSubmarinePage() {
    ...
    const generateProblemWithOptions = useCallback((mode: 'input' | 'multipleChoice' | 'voice', level: number) => {
        ...
        if (level === 1) {
            ...
            num1 = Math.floor(Math.random() * (maxNumber - 10)) + 10; // 10 to maxNumber
            num2 = Math.floor(Math.random() * (num1 - 1)) + 1; // 1 to num1-1
        }
    ...
    useEffect(() => {
        ...
        const wordsToNumbers: { [key: string]: string } = {
            ...
            'একત્રીশ': '31', 'বત્રીশ': '32', 'তেત્રીশ': '33', 'চৌત્રીশ': '34', 'পঁয়ત્રીশ': '35', 'ছત્રીশ': '36', 'সাঁইત્રીশ': '37', 'আটત્રીশ': '38', 'উনচল্লিশ': '39', 'চল্লিশ': '40',
            ...
            'একাত্তর': '71', 'বাহাত্তর': '72', 'তিয়াত্তর': '73', 'চুয়াত্তর': '74', 'پঁচাত্তর': '75', 'ছিয়াত্তর': '76', 'সাতাত্তর': '77', 'আটাত্তর': '78', 'উনআশি': '79', 'আশি': '80',
  ...
  return (
    <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/10 dark:to-orange-900/10 min-h-screen p-4">
            ...
            <Card className="w-full shadow-xl bg-white/60 dark:bg-card/60 backdrop-blur-sm">
                <CardHeader>
                    ...
                    <CardTitle className="text-center text-4xl md:text-7xl font-bold tracking-wider flex items-center justify-center flex-wrap gap-x-2 md:gap-x-4 gap-y-2 text-slate-700 dark:text-slate-200" style={{fontFamily: "'Lexend', sans-serif"}}>
                        ...
                        <span className="text-red-500 font-normal"><Minus /></span>
