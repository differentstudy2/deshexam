...
export async function generateMetadata({ params }: Props, parent: ResolvingMetadata): Promise<Metadata> {
  ...
  return {
    ...
    description,
    keywords,
    alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/practice/${slug}` },
    openGraph: {
      title, description,
      url: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/practice/${slug}`,
      siteName: 'DeshExam',
