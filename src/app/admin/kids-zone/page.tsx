...
export default function AddKidsContentPage() {
  ...
  const handleFormSubmit = async (data: FormValues) => {
    try {
      ...
      if (data.category === 'Fun Quizzes' && data.questions) {
        contentToSave.questions = data.questions;
        contentToSave.testType = 'Quiz'; // So it can be played
      }
                ...
                {form.watch('category') === 'Fun Quizzes' && (
                    <div className="space-y-6 pt-4 border-t">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <ImageUploader
                                                            fieldName={field.name}
                                                            onUrlChange={(url) => form.setValue(`questions.${index}.image`, url)}
                                                            value={field.value}
                                                        />
                                                    </FormControl>
                                                    <FormMessage />
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel>Question Audio URL</FormLabel>
                                                    <FormControl>
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => append({ text: '', options: [{text: ''}, {text: ''}, {text: ''}, {text: ''}], correctAnswer: '' })}
                        >
