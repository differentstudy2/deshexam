...
export default function ManageBlogsPage() {
  ...
  const fetchItems = async () => {
    try {
      setLoading(true);
      const allContent = await getAllContent("Blog");
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
            <div>
                <h1 className="font-headline text-3xl font-bold">Manage Blogs</h1>
                <p className="text-muted-foreground">View, edit, and delete all blog posts.</p>
            </div>
            <Button asChild>
       ...
       <AlertDialog open={!!itemToDelete} onOpenChange={() => setItemToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the blog post "{itemToDelete?.title}".
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
