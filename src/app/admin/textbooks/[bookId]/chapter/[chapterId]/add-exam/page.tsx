...
export default function AddChapterExamPage() {
  ...
  const handleFormSubmit = async (data: FormValues) => {
    try {
      ...
      router.push(`/admin/textbooks/${textbookId}/chapter/${chapterId}/exams`);
        ...
        <div className="flex justify-between items-center mb-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Create a new exam for this chapter.
                </p>
            </div>
             <Button asChild variant="outline">
                <Link href={`/admin/textbooks/${textbookId}/chapter/${chapterId}/exams`}>
                    Back to Exams
                </Link>
            </Button>
        </div>
