...
import type { Question, Topic, Textbook, Chapter, Exam } from '@/lib/types';
...
export default function ExamClientPage({ initialTest, initialTextbook, initialChapter, initialTopic }: { initialTest: Exam, initialTextbook: Textbook, initialChapter: Chapter, initialTopic: Topic | null }) {
        ...
        <div className="space-y-6">
            ...
            <header>
                <h1 className="font-headline text-3xl font-bold">Exam: <span className="text-primary">{test?.title}</span></h1>
                 <p className="text-muted-foreground mt-1">Textbook: {initialTextbook?.title || 'N/A'} - Chapter: {initialChapter?.title || 'N/A'}</p>
            </header>
