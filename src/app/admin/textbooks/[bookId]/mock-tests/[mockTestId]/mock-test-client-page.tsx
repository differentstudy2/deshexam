...
export default function MockTestClientPage({ initialTest, initialTextbook }: { initialTest: Exam, initialTextbook: Textbook }) {
    ...
    const backUrl = `/admin/textbooks/${initialTextbook.id}/mock-tests`;
