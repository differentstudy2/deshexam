...
Difficulty
${testData.difficulty?.join(', ') || ''}

Duration
${(testData as any)?.durationMinutes || ''}

Questions
${(testData as any)?.questions?.length || 0}

Total Marks
${(testData as any)?.totalMarks || ''}

Pass Marks
${(testData as any)?.passMarks || ''}

Negative Marking
${(testData as any)?.negativeMarking ? 'Yes' : 'No'}
...
Price
${testData.access === 'free' ? 'FREE' : 'Premium'}
...
Automatically display MOCK TEST.
...
Automatically choose Start Mock Test.
                                        ...
                                        <TableRow key={test.id}>
                                            ...
                                            <TableCell className="text-right">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent>
                                                        <DropdownMenuItem asChild><Link href={getUrlForTest(textbookId, test.id)}><Eye className="mr-2"/>View</Link></DropdownMenuItem>
