...
import { Loader2, ArrowLeft, PlusCircle, Edit, Trash2, FileJson, Sparkles, Upload, FileText } from 'lucide-react';
...
import type { Question, Textbook, Exam as Quiz } from '@/lib/types';
...
export default function QuizClientPage({ initialTest, initialTextbook }: { initialTest: Quiz, initialTextbook: Textbook }) {
    ...
    const backUrl = `/admin/textbooks/${initialTextbook.id}/quizzes`;
                            ...
                            <DialogTrigger asChild>
                             ...
                             <DialogContent className="sm:max-w-2xl">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Describe the questions you want to create, and Gemini will generate them for this quiz.
                                    </DialogDescription>
                                </DialogHeader>
                                <Form {...aiForm}>
                    ...
                    {test.questions.length > 0 ? (
                        <ul className="space-y-2">
                             <li className="flex items-center p-3 border-b">
                                <Checkbox id="select-all" checked={selectedQuestions.length === test.questions.length && test.questions.length > 0} onCheckedChange={handleSelectAllQuestions} className="mr-4" />
