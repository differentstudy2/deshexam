...
export default function AddTextbookMockTestPage() {
  ...
  const handleFormSubmit = async (data: FormValues) => {
    try {
      ...
      router.push(`/admin/textbooks/${textbookId}/mock-tests`);
        ...
        <div className="flex justify-between items-center mb-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Create a new mock test for this textbook.
                </p>
            </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Final Mock Test - Physics" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <Card>
           ...
           <div className="flex items-center gap-4">
                ...
                >
                    ...
                    {form.formState.isSubmitting ? "Saving Mock Test..." : "Save Mock Test"}
                </Button>
           </div>
        </form>
      </Form>
