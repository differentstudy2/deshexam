    ...
    return (
        <div className="-mt-4 -mx-4 -mb-20 md:-mt-6 md:-mx-6 md:-mb-8 lg:-mt-8 lg:-mx-8 min-h-[calc(100vh-64px)] bg-gray-100 text-black py-10 px-4 md:px-8 font-sans print:p-0 print:m-0 print:bg-white print:text-black print:min-h-0 print:block group/settings">
            <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row gap-6 items-start print:block">
                ...
                html[data-layout="presentation"] .question-sidebar,
                                                    ...
                                                    <div key={q.id} className={`group/question ${bgColor} ${isLast ? 'flex-1 print:flex-none' : ''} border border-gray-200 p-6 rounded-lg print:border-none print:p-6 print:pt-8 print:pb-6 print:break-after-page print:[print-color-adjust:exact] break-inside-avoid print:break-inside-avoid flex flex-col relative [html[data-layout='presentation']_&]:pt-[8rem] [html[data-layout='presentation']_&]:pb-[6rem] [html[data-layout='presentation']_&]:px-[4rem] print:[html[data-layout='presentation']_&]:pt-[10rem] print:[html[data-layout='presentation']_&]:px-[4rem]`}>
                                                        ...
                                                        <div className="flex justify-between items-start mb-4">
                                                            ...
                                                            <div className="flex items-center gap-2 print:hidden">
                                                                <Link href={`/question/${q.slug || q.id}`} target="_blank" className="text-gray-400 hover:text-blue-500 transition-colors" title="View Question">
                                                                    <Eye className="w-4 h-4" />
                                                                </Link>
                                                                <Link href={`/admin/question-bank/academic-questions/${q.id}`} target="_blank" className="text-gray-400 hover:text-emerald-500 transition-colors" title="Edit Question">
