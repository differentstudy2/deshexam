...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${(mockTest as any).title} | ${(textbook as any).title} | DeshExam`;
  const description = `Take the interactive mock test "${(mockTest as any).title}" for the ${textbook.title} textbook. Check your knowledge and prepare for your exams.`;
  const keywords = [
