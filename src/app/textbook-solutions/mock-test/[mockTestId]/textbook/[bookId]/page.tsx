...
export async function generateMetadata(props: PageProps, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    return {
      ...
      openGraph: {
          title,
          description,
          url: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/textbook-solutions/mock-test/${params.mockTestId}/textbook/${params.bookId}`,
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 4,
            "name": cleanTitle,
            "item": `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/textbook-solutions/mock-test/${params.mockTestId}/textbook/${params.bookId}`
          }
        ]
      }
    ];
