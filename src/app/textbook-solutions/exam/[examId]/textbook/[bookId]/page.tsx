...
async function getPageData(params: { examId: string; bookId: string; }) {
...
export async function generateMetadata(props: PageProps, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    return {
      ...
      openGraph: {
          title,
          description,
          url: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/textbook-solutions/exam/${params.examId}/textbook/${params.bookId}`,
          images: [
              {
                  url: imageUrl,
                  width: 1200,
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 4,
            "name": cleanTitle,
            "item": `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/textbook-solutions/exam/${params.examId}/textbook/${params.bookId}`
          }
        ]
      }
    ];
