      ...
      <section className="relative w-full bg-[#0f172a] pt-24 pb-32 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter uppercase mb-4 flex justify-center items-center">
            <span className="bg-gradient-to-r from-[#00a651] to-teal-400 bg-clip-text text-transparent drop-shadow-lg">{t('title1')}</span>
            <span className="ml-3 text-white">{t('title2')}</span>
          </h1>
          <p className="text-lg md:text-xl text-[#00a651] mb-12">{t('subtitle')}</p>
