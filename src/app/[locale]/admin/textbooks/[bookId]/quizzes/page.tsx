...
export default function ManageTextbookQuizzesPage() {
    ...
    const fetchQuizzesAndTextbook = async () => {
                             ...
                             <div className="flex gap-2">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem onSelect={() => generateTitle('[Subject] Quick Quiz')}>[Subject] Quick Quiz</DropdownMenuItem>
                                        <DropdownMenuItem onSelect={() => generateTitle('[Textbook Title] Pop Quiz')}>[Textbook Title] Pop Quiz</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </div>
                        </div>
