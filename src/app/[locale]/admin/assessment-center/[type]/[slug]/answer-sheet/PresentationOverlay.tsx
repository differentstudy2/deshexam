                        ...
                        >
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    >
                                        <span className={`flex items-center justify-center font-black leading-none shrink-0 rounded-full shadow-sm border-2 ${qTextColor !== 'default' ? 'text-white border-[var(--q-color)]' : (bgTheme === 'video' ? 'text-white border-white/50 bg-black/30 backdrop-blur-md' : 'text-white border-[#EA4335] bg-[#EA4335]')}`} style={{ width: '2.2em', height: '2.2em', fontSize: 'calc(var(--q-size) * 0.85)', backgroundColor: qTextColor !== 'default' ? 'var(--q-color)' : undefined }}>Q{currentSlide + 1}</span>
