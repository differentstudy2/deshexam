...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/academy/${params.board}/${classSlug}`;
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": boardSlug,
        "item": `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/academy/${params.board}`
      },
      {
        "@type": "ListItem",
        "position": 4,
