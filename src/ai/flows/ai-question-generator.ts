...
- For 'True/False' questions, provide an options array with two items: one for 'True' and one for 'False'. Each option MUST have an explanation stating why the statement is true or false.
