...
const newPaperDom = `<div id="printable-paper" style={{ zoom: zoom } as React.CSSProperties} className="flex flex-col gap-8 print:gap-0 print:block relative">
            {pageBorderStyle === 'solid' && (
              <div className="hidden print:block fixed top-0 bottom-0 left-0 right-0 border-[1.5px] border-gray-800 pointer-events-none z-[100]"></div>
            )}
...
console.log('Super patch v2 applied successfully!');
